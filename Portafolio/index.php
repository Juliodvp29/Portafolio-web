        ...
        <nav class="nav bd-grid">
            ...
            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list">
                    ...
                    <li class="nav__item"><a href="#skills" class="nav__link">Habilides</a></li>
                    <li class="nav__item"><a href="#service" class="nav__link">Servicios</a></li>
     ...
     <main class="l-main">
         <section class="home bd-grid" id="home">
             ...
             <div class="home_social">
                 ...
                 <a href="https://github.com/Juliodvp29" target="_blank" class="home__social-icon"><i class='bx bxl-github'></i></a>
                 <a href="#" class="home__social-icon"><i class='bx bxl-google-plus'></i></a>
             </div>
             <div class="home_img">
                    <img src="/assets/img/home.png" alt="" width="600" height="600">
             </div>
         </section>
            ...
            <section class="about section" id="about">
                ...
                <div class="about__container bd-grid">
                   <div class="about__img">
                       <img src="/assets/img/about.png" alt="" class="about__img" id="flecha" width="250" height="250">
                   </div> 
      ...
      <footer class="footer">
          <p class="footer__title">Julio Otero</p>
          <div class="footer__social">
              <a href="#" class="footer__icon"><i class='bx bxl-facebook'></i></a>
              <a href="#" class="footer__icon"><i class='bx bxl-instagram'></i></a>
              <a href="#" class="footer__icon"><i class='bx bxl-whatsapp'></i></a>
          </div>
          <p>&#169, 2021 copyright todos los derechos reservados</p>
      </footer>
